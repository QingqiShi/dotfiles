# Generated by Powerlevel10k configuration wizard on 2026-02-28 at 14:08 GMT.
...
() {
  ...
  # Enable terminal shell integration: emit OSC 133 marks around prompts and commands so
  # supporting terminals (iTerm2, WezTerm, Kitty, VS Code, Warp, Ghostty) can jump between
  # prompts, collapse command output, and show command duration.
